...
void ArenaTeam::MemberLost(Player* player, uint32 againstMatchmakerRating, int32 teamratingchange)
{
...
void ArenaTeam::MemberWon(Player* player, uint32 againstMatchMakerRating, int32 ratingChange)
{
