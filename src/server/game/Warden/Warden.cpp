    ...
    case 2:
        {
            ...
            sWorld->BanAccount(BAN_ACCOUNT, accountName, duration.str(), "Uso de hack o programa no permitido en la comunidad, de no haber usado hack o programa alguno pasa un antiviurs a tu sistema y revisa el funcionamiento de tu firewall","Server");
